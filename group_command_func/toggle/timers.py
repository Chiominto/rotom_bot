...
class TimerSettingsView(discord.ui.View):
    ...
    async def pokemon_button(
        ...
        try:
            ...
            await interaction.edit_original_response(
                content=f"Modify your Timer Settings:\n{POKEMON_TIMER_EMOJI} Pokemon Timer set to **{display_text}**",
                view=self,
            )
            pretty_log(
                tag="info",
    ...
    async def fish_button(
        ...
        try:
            ...
            await interaction.edit_original_response(
                content=f"Modify your Timer Settings:\n{FISH_TIMER_EMOJI} Fish Timer set to **{display_text}**",
                view=self,
            )
            pretty_log(
                tag="info",
    ...
    async def battle_button(
        ...
        try:
            ...
            await interaction.edit_original_response(
                content=f"Modify your Timer Settings:\n{BATTLE_TIMER_EMOJI} Battle Timer set to **{display_text}**",
                view=self,
            )
            pretty_log(
                tag="info",
