...
PUBLIC_EMOJI = "⚡"  # electricity, Rotom’s core energy
STAFF_EMOJI = "🔌"  # plug, ties to appliances
TITLE_EMOJI = "👻"  # ghost, Rotom’s ghost typing
FOOTER_EMOJI = "📺"  # TV, one of Rotom’s classic forms
...
class CommandsView(commands.Cog):
    ...
    @app_commands.command(name="commands", description="View Rotom's commands!")
