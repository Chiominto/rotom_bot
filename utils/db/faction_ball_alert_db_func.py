...
async def upsert_user_faction_ball_alert_via_user_id(bot, user_id: int, user_name: str, notify: str):
    """
    Upsert a user's faction ball alert using user ID and name.
    ...
    """
    try:
        from utils.cache.faction_ball_alert_cache import upsert_faction_ball_alert_cache_via_user_id
        ...
        upsert_faction_ball_alert_cache_via_user_id(user_id=user_id, user_name=user_name, notify=notify)
