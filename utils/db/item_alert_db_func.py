...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
async def fetch_all_item_alerts(bot) -> list[asyncpg.Record]:
    """
    Fetch all rows where alert_type='item'.

    Args:
        bot: The Discord bot instance containing the PostgreSQL pool.

    Returns:
        List of asyncpg.Record representing all item alerts.
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# 💾 Fetch single user item alert
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
async def fetch_user_item_alert(bot, user_id: int) -> asyncpg.Record | None:
    """
    Fetch a single user's item alert row.
...
# 💾 Upsert item alert
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
async def upsert_user_item_alert(bot, user: discord.Member, notify: str):
    """
    Insert or update a user's item alert.
    ...
    user_name = user.name
    try:
        from utils.cache.item_alert_cache import upsert_item_alert_cache
        ...
        upsert_item_alert_cache(user=user, notify=notify)
...
async def upsert_user_item_alert_via_user_id(
    bot, user_id: int, user_name: str, notify: str
):
    """
    Upsert a user's item alert using user ID and name.
...
# 💾 Remove item alert
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
async def remove_user_item_alert(bot, user: discord.Member):
    """
    Remove a user's item alert row from DB and cache.
    ...
    try:
        ...
        remove_user_item_alert_cache(user=user)
...
# 💾 Update notify type
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
async def update_user_item_notify(bot, user: discord.Member, new_notify: str):
    """
    Update a user's `notify` type for item alerts.
    ...
    try:
        from utils.cache.item_alert_cache import (
            update_item_alert_notify_type_cache,
        )
        ...
        update_item_alert_notify_type_cache(user=user, new_notify=new_notify)
