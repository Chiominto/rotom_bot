...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
async def fetch_all_egg_alerts(bot) -> list[asyncpg.Record]:
    """
    Fetch all rows where alert_type='egg'.

    Args:
        bot: The Discord bot instance containing the PostgreSQL pool.

    Returns:
        List of asyncpg.Record representing all egg alerts.
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# 💾 Fetch single user egg alert
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
async def fetch_user_egg_alert(bot, user_id: int) -> asyncpg.Record | None:
    """
    Fetch a single user's egg alert row.
...
# 💾 Upsert egg alert
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
async def upsert_user_egg_alert(bot, user: discord.Member, notify: str):
    """
    Insert or update a user's egg alert.
    ...
    user_name = user.name
    try:
        from utils.cache.egg_alert_cache import upsert_egg_alert_cache
        ...
        upsert_egg_alert_cache(user=user, notify=notify)
...
async def upsert_user_egg_alert_via_user_id(
    bot, user_id: int, user_name: str, notify: str
):
    """
    Upsert a user's egg alert using user ID and name.
    ...
    """
    try:
        from utils.cache.egg_alert_cache import (
            upsert_egg_alert_cache_via_user_id,
        )
...
# 💾 Remove egg alert
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
async def remove_user_egg_alert(bot, user: discord.Member):
    """
    Remove a user's egg alert row from DB and cache.
    ...
    try:
        ...
        remove_user_egg_alert_cache(user=user)
...
# 💾 Update notify type
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
async def update_user_egg_notify(bot, user: discord.Member, new_notify: str):
    """
    Update a user's `notify` type for egg alerts.
    ...
    try:
        from utils.cache.egg_alert_cache import (
            update_egg_alert_notify_type_cache,
        )
        ...
        update_egg_alert_notify_type_cache(user=user, new_notify=new_notify)
