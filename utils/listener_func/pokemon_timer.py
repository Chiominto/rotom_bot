            ...
            try:
                ...
                if setting == "on":
                    ...
                    await _retry_discord_call(
                        ...
                        f"{POKEMON_TIMER_EMOJI} {member.mention}, your </pokemon:1015311085441654824> command is ready!",
                    )
                elif setting == "on w/o pings" or setting == "on_no_pings":
                    debug_log(f"Notifying without mention for {member}")
                    await _retry_discord_call(
                        message.channel.send,
                        f"{POKEMON_TIMER_EMOJI} **{member.name}**, your </pokemon:1015311085441654824> command is ready!",
                    )
                elif setting == "react":
